...
| `中文官方` | Vue Router 中文文档     | https://router.vuejs.org/zh/                                  | Vue 单页应用路由、导航守卫、动态路由         |
| `英文官方` | Vue Router Docs         | https://router.vuejs.org/                                     | Vue Router 原文文档                          |
| `中文官方` | Pinia 中文文档          | https://pinia.vuejs.org/zh/                                   | Vue 状态管理                                 |
| `英文官方` | Pinia Docs              | https://pinia.vuejs.org/                                      | Pinia 原文文档                               |
| `英文官方` | TanStack Query Vue Docs | https://tanstack.com/query/latest/docs/framework/vue/overview | Vue Query、server state、query key、mutation |
| `中文官方` | Ant Design Vue 中文文档 | https://www.antdv.com/components/overview-cn                  | Vue 企业级组件库、表单、表格、反馈           |
| `英文官方` | Ant Design Vue Docs     | https://www.antdv.com/components/overview                     | Ant Design Vue 原文 API                      |
...
- 组件 props / emits
- Composition API
- Vue Router 的 `RouterLink`、`RouterView`、route meta 和导航守卫
- Pinia 的 `defineStore`
...
- `packages/ui-vue/src/`
- `docs/03-react-components-routing.md`
- `docs/16-appshell-reading-guide.md`
...
| `英文官方` | TanStack Query Vue Docs  | https://tanstack.com/query/latest/docs/framework/vue/overview           | Vue Query 原文和最新 API                       |
| `英文官方` | Zustand Docs             | https://zustand.docs.pmnd.rs/                                           | client state、store、selector、持久化          |
| `中文官方` | Pinia 中文文档           | https://pinia.vuejs.org/zh/                                             | Vue client state、store、actions、持久化边界   |
...
- `apps/web/src/components/leadFormSchema.ts`
- `apps/web-vue/src/stores/`
- `apps/web-vue/src/components/LeadForm.vue`
- `apps/web-vue/src/components/leadFormSchema.ts`
- `apps/web-vue/src/lib/bookingDrafts.ts`

重点问题：

- 服务端状态和客户端状态为什么要分开。
- React Query 为什么不等同于 Zustand。
- Vue Query 为什么不等同于 Pinia。
...
| `英文官方` | Testing Library Vue   | https://testing-library.com/docs/vue-testing-library/intro/   | 从用户视角测试 Vue 组件              |
...
| Vue 对照        | Vue 中文文档 + Pinia 中文文档                                 | Vue Guide + TanStack Query Vue Docs         |
