...
const exactRouteMetadata: Record<string, RouteMetadata> = {
  "/": {
    ...
    description:
      "Explore a Vue, TypeScript, FastAPI, testing, accessibility, and production-readiness learning lab.",
  },
  "/admin": {
    title: `Lead Console | ${siteName}`,
    description:
      "Review local demo leads with protected routing, role checks, charts, and tables.",
  },
  "/book": {
    title: `Book a Walkthrough | ${siteName}`,
    description:
      "Submit a local booking request and practice resilient form workflows.",
  },
  "/learn": {
    title: `Learning Roadmap | ${siteName}`,
    description:
      "Follow the frontend learning roadmap from foundations through production skills.",
  },
  "/login": {
    title: `Login | ${siteName}`,
    description:
      "Practice JWT demo authentication and protected route behavior.",
  },
  "/products": {
    title: `Product Catalog | ${siteName}`,
    description:
      "Search and compare LumaDock products backed by API data and resilient fallbacks.",
  },
};
...
export function getRouteMetadata(pathname: string): RouteMetadata {
  if (pathname.startsWith("/products/")) {
    return {
      ...
      description:
        "Explore a LumaDock product detail page with specs, configuration, and booking.",
    };
  }
